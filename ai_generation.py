...
class Generation:
    def __init__(self, video, audio):
        ...
        self.chat_prompt = """I will give you a bunch of lists. I want you to choose a random item from each of the lists and generate 5 unique prompts that can be used to create AI art. I want each prompt you give to follow a unique and fancy art style different from the others. The first list is a list of captions describing the video. Only use this value in TWO of the prompts generated. The second list is a list of objects. The third list if a list of emotions. the fourth list is a list of colors given in RGB. ONLY for this list you should convert the RGB values to their closest color name and select three colors to use. The fourth list is a connotation, and the fifth list is a list of keywords. I would like atleast one prompt to emphasize emotions through color, and at least one prompt be a fully abstracted version of the first list . Use random weights to determine how important a piece of information is for the prompt. Generate titles for each image as well. For some of the prompts follow art styles from famous artists. ONLY GIVE ME THE YOUR RESPONSE IN THE FORMAT ["title 1", "prompt 1", "title 2", "prompt 2", "titile 3", "prompt3"]. 
                            ...
                            your response: ["Connected in Isolation", "Create an realistic detailed Baroque painting using the colors RGB(141, 161, 158) and RGB(145, 172, 173) to convey a feeling of gratitude. The painting should depict a person on a couch, lost in their cellphone, and a TV in the background, with the emphasis on the glowing screen. The style should be inspired by the works of Caraviaggio", "The Blue Serenity", "Create a realistic oil painting of a person sitting on a chair, holding a bottle and looking at their cellphone. Use the colors RGB(145, 160, 158) and RGB(167, 184, 182) to convey a neutral emotion. The background should be blurry, with emphasis on the person and the bottle, and the style should be inspired by the works of Edward Hopper.", "The Joy of Life", "Create a vibrant Bauhaus style painting using the colors RGB(147, 173, 171) and RGB(142, 168, 166) to convey a feeling of happiness. The painting should depict a person sitting on a couch, holding a cellphone, with a TV in the background. The focus should be on the person's expression, conveying a sense of contentment and joy. The style should be inspired by the works of Paul Klee.", "Grateful Reflections", "Create a pop art drawing using the colors RGB(136, 162, 165) and RGB(147, 159, 158) to convey a feeling of gratitude. The painting should depict a person on a couch, holding a bottle, with a TV in the background. The focus should be on the reflection of the person in the bottle, conveying a sense of introspection and appreciation. The style should be inspired by the works of Andy Warhol." , "The Winning Shot", "Create a classical style painting using the colors RGB(138, 150, 149) to convey a positive emotion. The piece should depict a person holding a basketball, sitting on a couch, with a cellphone and a TV in the background. The focus should be on the person's confident expression, conveying a sense of accomplishment and success. The style should be inspired by the works of Keith Haring."]
                            ...
                            your response: ["Media Overload", "Create a digital art piece inspired by the works of Salvador Dali, using the color RGB(231, 233, 226) to convey a neutral emotion. The piece should depict a person sitting on a chair, holding a book, with a TV in the background. The TV should display a distorted image of a dog, representing the person's confusion and disconnection from reality.", "A Furry Companion", "Create a futuristic Bauhaus style painting inspired by the works of Walter Gropius, using the colors RGB(229, 232, 230) to convey a feeling of admiration. The painting should depict a person sitting on a couch, with a dog laying on their lap, both looking at a TV. The focus should be on the dog's expression, conveying a sense of love and loyalty.", "The Rage Inside", "Create a black and white drawing inspired by the works of Mark Rothko, using the color RGB(231, 178, 146) to convey an angry emotion. The painting should depict a person standing in front of a desk, with a chair tipped over and a remote in their hand. The focus should be on the person's expression, conveying a sense of frustration and anger.", "A Relaxing Evening", "Create a realistic surrealist style painting inspired by the works of Salvador Dali, using the colors RGB(228, 231, 229) to convey a positive emotion. The piece should depict a person sitting on a bed, holding a remote, with a TV and a book on the nightstand. The focus should be on the person's expression, conveying a sense of relaxation and contentment.", "The World in Our Hands", "Create an classical painting inspired by the works of Vincent Van Gogh, using the colors RGB(240, 198, 165) and RGB(239, 197, 164) to convey an excited emotion. The painting should depict a person holding a remote, with a TV in the background displaying a world map. The focus should be on the person's expression, conveying a sense of wonder and excitement about the world. The style should be with smooth lines and bold colors."]
